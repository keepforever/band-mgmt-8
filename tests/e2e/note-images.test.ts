...
test('Users can create note with an image', async ({ page, login }) => {
  ...
  await page.getByLabel('image').nth(0).setInputFiles('tests/fixtures/images/kody-notes/cute-koala.png')
...
test('Users can create note with multiple images', async ({ page, login }) => {
  ...
  await page.getByLabel('image').nth(1).setInputFiles('tests/fixtures/images/kody-notes/koala-coder.png')
