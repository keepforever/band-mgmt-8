  ...
  return (
    <button
      ...
      className={cn({
        ...
        'bg-blue-800 py-1.5 text-white hover:bg-blue-500 focus:z-10': isBlackoutForUser,
        'bg-red-800 py-1.5 text-white hover:bg-red-500 focus:z-10': isBlackoutForCurrentUser,
