 ...
 * @returns {void}
 */
export function logObjectDetails(objects: Record<string, any>, filename: string, color?: string): void {
  console.group(
    `%c${filename}`,
    `color: ${color || getBrightColor(filename || '')}; font-size: 13px; font-weight: bold;`,
  )
